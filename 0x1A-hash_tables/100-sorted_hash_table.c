 ...
 * @size: parameter number of array slots to make the table.
 *
...
/**
 * set_spair_only - function set key:value
 * pair to first array element
 * @ht: hash table.
 * @key: the key that we look for
 * @value: the value associated with the key
...
/**
 * update_value - function updates the value of a given node.
...
/**
 * set_spair_front - function sets key:value pair node
 * to front of given index's list.
 * @ht: parameter hash table.
...
/**
 * slist_set_first - function sets the first addition
 * to the sorted list.
...
/**
 * slist_set - function sets a new node
 * before the given old node.
 * @ht: hash table.
 * @old_node: the node to place in front.
...
/**
 * slist_set_end - function sets a node at the end of the sorted list
 * @ht: pointer to the sorted hash table.
...
/**
 * shash_table_set - function adds or updates an
 * element to the sorted hash table.
 * @ht: hash table.
 * @key: the key we are lookig for
 * @value: the value associated with the key, can be an empty string.
 *
...
/**
 * shash_table_print_rev - function prints sorted
 * key/value pairs in reverse.
 * @ht: the sorted hash table.
 */
